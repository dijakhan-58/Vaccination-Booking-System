        ...
        <div class="card card-custom p-3 p-md-4">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="h3 fw-bold text-slate-800 mb-0">Add Vaccine</h1>
                        <p class="text-muted small mb-0">Create a new vaccine record in the system</p>
                    </div>
                </div>
            ...
            <form action="#" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="availability_status" class="form-select" required>
                            ...
                            <option value="limited" {{ old('availability_status') == 'limited' ? 'selected' : '' }}>Limited
                            </option>
                ...
                <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                    <a href="{{ route('vaccines.index') }}" class="btn btn-outline-secondary">Cancel</a>
