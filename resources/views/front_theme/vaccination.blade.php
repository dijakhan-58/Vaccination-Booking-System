      ...
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <div style="display: flex; align-items: center; justify-content: center; gap: 12px; font-size: 16px;">
            ...
            <span style="color: #8eb69b; font-weight: 600; text-shadow: 0 2px 10px rgba(0,0,0,0.3);">Vaccines</span>
          </div>
        </div>
      </div>
    </div>
        ...
        @forelse ($vaccines as $vaccine)
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="vc_vaccine_card w-100">
              <div class="cs_iconbox cs_style_2 cs_radius_15 cs_white_bg h-100 d-flex flex-column">
                <div class="cs_iconbox_header d-flex align-items-center justify-content-between">
                  <span class="vc_badge" style="background:#DAF1DE;color:#051F20;">
                    {{ $vaccine->disease }}
                  </span>
                  <span class="vc_badge" style="background:#E8F5E9;color:#051F20;">
                    {{ ucfirst($vaccine->availability_status) }}
                  </span>
                </div>
                ...
                <ul class="cs_mp0" style="list-style:none;">
                  @if ($vaccine->recommended_age_days)
                    <li><i class="fa-regular fa-clock"></i> Recommended at: {{ $vaccine->recommended_age_days }} days</li>
                  @endif
                  <li><i class="fa-solid fa-syringe"></i> {{ $vaccine->dose_count }}
                    {{ Str::plural('dose', $vaccine->dose_count) }}</li>
                  @if ($vaccine->manufacturer)
                    <li><i class="fa-solid fa-industry"></i> {{ $vaccine->manufacturer }}</li>
                  @endif
                </ul>
                <div class="mt-auto pt-3">
                  {{-- TODO: abhi temporary '#' hai — jab appointment route/page ban jaye to yahan lagayein --}}
                  <a href="#" class="cs_btn cs_style_1 cs_color_1 w-100 justify-content-center">
