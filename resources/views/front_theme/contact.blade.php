            ...
            <section class="py-5">
                <div class="container">
                    ...
                    <div class="row g-4 mb-5">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="mailto:care@vaccicare.com" class="text-decoration-none">
                                <div class="card border-0 shadow-sm h-100 text-center p-4">
                                    <div class="d-inline-flex align-items-center justify-content-center bg-success bg-opacity-10 text-success rounded-circle mx-auto mb-3"
                                        style="width:65px;height:65px;">
                    ...
                    <div class="row g-3 mb-5">
                        ...
                        <div class="col-lg-6">
                            <div class="bg-light rounded-3 p-4 h-100">
                                <h6 class="mb-2"><i class="fa-solid fa-circle-question text-success me-2"></i>What are your working
                                    hours?</h6>
                        ...
                        <div class="col-lg-6">
                            <div class="bg-light rounded-3 p-4 h-100">
                                <h6 class="mb-2"><i class="fa-solid fa-circle-question text-success me-2"></i>How can I reach your
                                    support team?</h6>
